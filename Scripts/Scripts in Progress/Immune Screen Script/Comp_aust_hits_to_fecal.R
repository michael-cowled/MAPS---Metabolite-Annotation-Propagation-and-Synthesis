...
#results of overlap
A.unstim <- read.csv("C:/Users/mcowled/Downloads/Microbiome McConville Lab Primary Screen PMC266  BMDM Subpopulation Percentages - Results   Plate A Unstimulated.csv")
A.unstim$Compound_Name <- gsub("_", " ", A.unstim$Compound_Name)
B.negpos <- read.csv("C:/Users/mcowled/Downloads/Microbiome McConville Lab Primary Screen PMC266  BMDM Subpopulation Percentages - Results   Plate B IL4  IL13 Stimulated (1).csv")
B.negpos$Compound_Name <- gsub("_", " ", B.negpos$Compound_Name)
B.pospos <- read.csv("C:/Users/mcowled/Downloads/Microbiome McConville Lab Primary Screen PMC266  BMDM Subpopulation Percentages - Results   Plate B IL4  IL13 Stimulated (2).csv")
B.pospos$Compound_Name <- gsub("_", " ", B.pospos$Compound_Name)
C.negpos <- read.csv("C:/Users/mcowled/Downloads/Microbiome McConville Lab Primary Screen PMC266  BMDM Subpopulation Percentages - Results   Plate C LPS  IFNg Stimulated (1).csv")
C.negpos$Compound_Name <- gsub("_", " ", C.negpos$Compound_Name)

#total results
M0_pos_inos <- read.csv("C:/Users/mcowled/Downloads/KW_PMC266_FC 15_Hit_Dose_Count_M0_pos_inos.csv")
M0_pos_inos$Compound_Name <- gsub("_", " ", M0_pos_inos$Compound_Name)
M0_pos_arg <- read.csv("C:/Users/mcowled/Downloads/KW_PMC266_FC 15_Hit_Dose_Count_M0_pos_arg.csv")
M0_pos_arg$Compound_Name <- gsub("_", " ", M0_pos_arg$Compound_Name)

M1_pos_inos <- read.csv("C:/Users/mcowled/Downloads/KW_PMC266_FC 0.2_Hit_Dose_Count_M1_pos_inos.csv")
M1_pos_inos$Compound_Name <- gsub("_", " ", M1_pos_inos$Compound_Name)
M1_pos_arg <- read.csv("C:/Users/mcowled/Downloads/KW_PMC266_FC 15_Hit_Dose_Count_M1_pos_arg.csv")
M1_pos_arg$Compound_Name <- gsub("_", " ", M1_pos_arg$Compound_Name)

M2_pos_inos <- read.csv("C:/Users/mcowled/Downloads/KW_PMC266_FC 15_Hit_Dose_Count_M2_pos_inos.csv")
M2_pos_inos$Compound_Name <- gsub("_", " ", M2_pos_inos$Compound_Name)
M2_pos_arg <- read.csv("C:/Users/mcowled/Downloads/KW_PMC266_FC 1.15_Hit_Dose_Count_M2_pos_arg.csv")
