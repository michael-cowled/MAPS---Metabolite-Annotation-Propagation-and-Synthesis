...
# ---------------------------------------------------------------------------
shiny::addResourcePath(prefix = "assets", directoryPath = "Y:/MA_BPA_Microbiome/Archive")
...
required_packages <- c(
  "MAPS.Package", "dplyr", "tidyr", "stringr", "readr",
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      textInput("dataset_id", "Dataset ID", "HGMD_0261"),
      textInput("folder", "Processed data folder", "Y:/MA_BPA_Microbiome/LCMS data/HGMD_0261_MC01-17_negative"),
      textInput("gnps_task", "GNPS task ID", "ee02f33b50a548d290d6f4b4153b1ca3"),
      textInput("cid_db", "PubChem SQLite path", "Y:/MA_BPA_Microbiome/Databases/PubChem/PubChem_Indexed.sqlite"),
